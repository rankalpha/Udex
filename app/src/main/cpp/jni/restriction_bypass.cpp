...
// bool ShouldDenyAccessToMember<ArtField>(ArtField *, const&, art::hiddenapi::AccessMethod)
    ...
    void hook() {
        ...
        if (func_addr1 != nullptr) {
            ...
            DobbyHook(func_addr1, (dobby_dummy_func_t)&new_art_hiddenapi_ShouldDenyAccessToMember_ArtMethod, (dobby_dummy_func_t *)&orig_art_hiddenapi_ShouldDenyAccessToMember_ArtMethod);
        } else {
        ...
        if (func_addr2 != nullptr) {
            ...
            DobbyHook(func_addr2, (dobby_dummy_func_t)&new_art_hiddenapi_ShouldDenyAccessToMember_ArtField, (dobby_dummy_func_t *)&orig_art_hiddenapi_ShouldDenyAccessToMember_ArtField);
        } else {
