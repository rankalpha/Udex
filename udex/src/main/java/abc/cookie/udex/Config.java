...
public class Config {
    ...
    boolean isUseGumJs;        // 是否使用frida_GumJS来运行脚本
    ...
    public String toString() {
        ...
        sb.append(String.format("isEnabled: %b, isUseGumJs: %b, isDumpDex: %b, isDumpCode: %b, isDumpCodeByClassList: %b, delaySeconds: %d", this.isEnabled, this.isUseGumJs, this.isDumpDex, this.isDumpCode, this.isDumpCodeByClassList, this.delaySeconds));
